...
def image_create(request): 
    if request.method == 'POST': # form is sent 
        ...
        if form.is_valid(): # form data is valid 
...
def image_list(request): 
    ...
    try: 
        ...
        if images_only: # If AJAX request and page out of range # return an empty page 
            return HttpResponse('') # If page out of range return last page of results 
